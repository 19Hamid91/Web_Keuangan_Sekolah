  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Data Tagihan</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('tagihan.update', ['tagihan' => $data->id]) }}" method="post">
                        @csrf
                        @method('patch')
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="kode" class="form-control" placeholder="Kode Tagihan" value="{{ $data->kode }}" required>
                              </div>
                            </div>
                          </div>
                          <div class="col-sm-6">
