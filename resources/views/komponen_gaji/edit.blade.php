  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Data Komponen Gaji</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('komponen_gaji.update', ['komponen_gaji' => $data->id]) }}" method="post">
                        @csrf
                        @method('patch')
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="kode" class="form-control" placeholder="Kode Komponen Gaji" value="{{ $data->kode }}" required readonly>
                              </div>
                            </div>
                          </div>
                          <div class="col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                              ...
                              <div class="input-group mb-3">
                                  ...
                                  <input type="text" name="nominal" class="form-control" placeholder="Nominal" value="{{ old('nominal') ?? $data->nominal }}" required>
                              </div>
                              </div>
                          </div>
                        </div>
