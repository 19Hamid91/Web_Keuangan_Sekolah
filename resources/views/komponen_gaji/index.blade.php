  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Komponen Gaji</h1>
          </div>
          <div class="col-sm-6">
            <a href="{{ route('komponen_gaji.create') }}" class="btn btn-primary float-sm-right">Tambah</a>
          </div>
        </div>
      </div>
    </div>
                      ...
                      @foreach ($komponenGaji as $item)
                          <tr>
                            ...
                            <td class="text-center">
                              ...
                              <a href="{{ route('komponen_gaji.show', ['komponen_gaji' => $item->id]) }}" class="btn bg-secondary pt-1 pb-1 pl-2 pr-2 rounded">
