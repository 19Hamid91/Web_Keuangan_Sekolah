        ...
        <div class="row">
                ...
                <div class="card-body">
                  <div class="row ps-2 pe-2">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <a href="{{ route('laporan_data.print_registrasi', ['instansi' => $instansi, 'export' => 'pdf']) }}" class="btn btn-danger w-100">PDF</a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <a href="{{ route('laporan_data.print_registrasi', ['instansi' => $instansi, 'export' => 'excel']) }}" class="btn btn-success w-100">EXCEL</a>
                    </div>
                  </div>
                </div>
            </div>
          ...
          <div class="col-lg-6">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form action="{{ route('laporan_data.print_registrasi', ['instansi' => $instansi]) }}" method="get">
                  @csrf
