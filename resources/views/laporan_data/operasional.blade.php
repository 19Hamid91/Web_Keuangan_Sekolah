  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Laporan Operasional</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
                ...
                <div class="card-body">
                  <div class="row ps-2 pe-2">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <a href="{{ route('laporan_data.print_operasional', ['instansi' => $instansi, 'export' => 'pdf']) }}" class="btn btn-danger w-100">PDF</a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <a href="{{ route('laporan_data.print_operasional', ['instansi' => $instansi, 'export' => 'excel']) }}" class="btn btn-success w-100">EXCEL</a>
                    </div>
                  </div>
                </div>
            </div>
          ...
          <div class="col-lg-6">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form action="{{ route('laporan_data.print_operasional', ['instansi' => $instansi]) }}" method="get">
                  @csrf
                <div class="row ps-2 pe-2 mb-3">
                  ...
                  <div class="col-sm-3 ps-0 pe-0">
                      <select id="filterKaryawan" name="filterKaryawan" class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" title="Karyawan">
