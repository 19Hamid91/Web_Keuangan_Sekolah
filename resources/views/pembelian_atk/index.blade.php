    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          @if((Auth::user()->instansi_id == $data_instansi->id && in_array(Auth::user()->role, ['BENDAHARA', 'TU'])) || in_array(Auth::user()->role, ['ADMIN']))
          <div class="col-sm-6">
                      ...
                      @foreach ($data as $item)
                          <tr>
                            ...
                            <td class="text-center">
                              <a href="{{ route('pembelian-atk.cetak', ['id' => $item->id, 'instansi' => $instansi]) }}" class="btn bg-success pt-1 pb-1 pl-2 pr-2 rounded" target="_blank">
...
@section('js')
    <script>
      ...
      function applyFilters() {
          ...
          if (atk === "ATK" && supplier === "Supplier") {
              table.search("").columns().search("").draw();
            } else if (atk !== "ATK" && supplier === "Supplier") {
