  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tambah Data Penggajian</h1>
          </div>
        </div>
      </div>
    </div>
                          ...
                          <div class="col-sm-4">
                            ...
                            <select class="form-control select2" style="width: 100%" data-dropdown-css-class="select2-danger" id="karyawan_id" name="karyawan_id" required>
                                ...
                                @foreach ($karyawans as $item)
                                    <option value="{{ $item->id }}" {{ old('karyawan_id') == $item->id ? 'selected' : '' }}>({{ $item->nip }}) {{ $item->nama_gurukaryawan }}</option>
                                @endforeach
                            </select>
                            </div>
                          </div>
                              ...
                              <table class="table table-bordered w-100">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><input type="text" id="jumlah_uang_makan" class="form-control" required value="0"></td>
                                  ...
                                  <tr>
                                    ...
                                    <td><input type="text" id="jumlah_askes" class="form-control" required value="0"></td>
    ...
    <script>
      ...
      function processData(responseData) {
          ...
          if (data) {
              ...
              $('#presensi_karyawan_id').attr('disabled', false);
