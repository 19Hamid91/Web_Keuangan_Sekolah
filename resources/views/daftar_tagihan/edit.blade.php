  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Data Daftar tagihan</h1>
          </div>
        </div>
      </div>
    </div>
                    ...
                    <form action="{{ route('daftar_tagihan.update', ['daftar_tagihan' => $data->id]) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="nominal" class="form-control" placeholder="Nominal" value="{{ $data->nominal }}" required>
                                </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="input-group mb-3">
                                    <input type="number" name="persen_yayasan" class="form-control" placeholder="Presentase Yayasan" value="{{ $data->persen_yayasan }}" min="0" max="100" required>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <input type="date" name="awal_pembayaran" class="form-control" placeholder="Awal Pembayaran" value="{{ $data->awal_pembayaran }}" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                <label>Akhir Pembayaran</label>
                                <input type="date" name="akhir_pembayaran" class="form-control" placeholder="Akhir Pembayaran" value="{{ $data->akhir_pembayaran }}" required>
                                </div>
                            </div>
                        </div>
                        <div>
