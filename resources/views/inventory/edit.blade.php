        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('inven.update', ['inven' => $data->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            ...
                            <input type="number" id="jumlah" name="jumlah" class="form-control" placeholder="Jumlah" value="{{ $data->jumlah }}" required>
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-sm-6">
                            ...
                            <input type="text" id="lokasi_penyimpanan" name="lokasi_penyimpanan" class="form-control" placeholder="Lokasi Penyimpanan" value="{{ $data->lokasi_penyimpanan }}" required>
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form-group">
