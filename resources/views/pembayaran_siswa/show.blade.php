                  ...
                  <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="total_{{ $i }}" name="total[]" class="form-control" placeholder="Total Bayar" value="{{ $item->total ?? 0 }}" disabled>
                            </td>
                            <td>
                                <input type="text" id="sisa_{{ $i }}" name="sisa[]" class="form-control" placeholder="Sisa Pembayaran" value="{{ $item->sisa ?? 0 }}" disabled readonly>
                            </td>
                            <td>
