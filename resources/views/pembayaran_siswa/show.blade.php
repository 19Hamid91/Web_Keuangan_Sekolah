                      ...
                      <div class="col-sm-4">
                          <div class="form-group">
                              ...
                              <div class="input-group mb-3">
                                  <input type="date" name="tanggal" class="form-control" placeholder="Tanggal" value="{{ $data->first()->tanggal ?? date('Y-m-d') }}" disabled>
                              </div>
                          </div>
                      </div>
                      <div class="col-sm-4">
                  ...
                  <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="total_{{ $i }}" name="total[]" class="form-control text-right" placeholder="Total Bayar" value="{{ $item->total ?? 0 }}" disabled>
                            </td>
                            <td>
                                <input type="text" id="sisa_{{ $i }}" name="sisa[]" class="form-control text-right" placeholder="Sisa Pembayaran" value="{{ $item->sisa ?? 0 }}" disabled readonly>
                            </td>
                            <td>
                                <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" id="tipe_pembayaran_{{ $i }}" name="tipe_pembayaran[]" disabled>
