        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
                <!-- /.card-header -->
                <div class="card-body">
                  <h3 class="text-center font-weight-bold">Detail Data Kenaikan</h3>
                  <br><br>
                  <div class="row">
                    <div class="col-sm-12">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" id="kode_kelas_awal" name="kode_kelas_awal" disabled disabled>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                      <label>Kelas</label>
                      <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" id="kode_kelas_akhir" name="kode_kelas_akhir" disabled disabled>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                      <label>Siswa</label>
                      <select class="form-control select2" data-dropdown-css-class="select2-danger" id="nis_siswa" name="nis_siswa" disabled>
                    ...
                    <div class="col-sm-6">
                      ...
                      <label>Tanggal</label>
                      <div class="input-group mb-3">
                        <input type="date" name="tanggal" class="form-control" placeholder="Tanggal" value="{{ $data->tanggal ?? date('Y-m-d') }}" readonly>
                      </div>
                      </div>
                    </div>
                  </div>
