...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <button class="btn btn-primary float-sm-right" data-target="#modal-donatur-create" data-toggle="modal">Tambah</button>
          </div>
          @endif
        </div>
      </div>
    ...
    {{-- Modal Start --}}
    <div class="modal fade" id="modal-donatur-create">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ route('donatur.store', ['instansi' => $instansi]) }}" method="post">
              @csrf
              <div class="form-group">
                <label for="nama">Nama Donatur</label>
                <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Donatur" value="{{ old('nama') }}" required>
              </div>
              <div class="form-group">
    ...
    <div class="modal fade" id="modal-donatur-edit">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Edit Data Donatur</h4>
            <button
              type="button"
              class="close"
              data-dismiss="modal"
          ...
          <div class="modal-body">
            <form id="edit-form" action="" method="post">
              ...
              <div class="form-group">
                <label for="nama">Nama Donatur</label>
                <input type="text" class="form-control" id="edit_nama" name="nama" placeholder="Nama Donatur" value="{{ old('nama') }}" required>
              </div>
              <div class="form-group">
                <label for="alamat">Alamat</label>
...
@section('js')
    <script>
        ...
        function edit(id, nama, alamat, telpon){
          $('#edit-form').attr('action', 'donatur/'+id+'/update')
          $('#edit_nama').val(nama)
          $('#edit_alamat').val(alamat)
          $('#edit_telpon').val(telpon)
          $('#modal-donatur-edit').modal('show')
        }
        function remove(id){
