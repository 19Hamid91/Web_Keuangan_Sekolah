      ...
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ route('aset.store', ['sekolah' => $sekolah]) }}" method="post">
              @csrf
              <div class="form-group">
                <label for="nama">Nama Aset</label>
                <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Aset" value="{{ old('nama') }}" required>
              </div>
              <div class="form-group">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="edit-form" action="" method="post">
              ...
              <div class="form-group">
                <label for="nama">Nama Aset</label>
                <input type="text" class="form-control" id="edit_nama" name="nama" placeholder="Nama Aset" value="{{ old('nama') }}" required>
              </div>
              <div class="form-group">
