        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
                <!-- /.card-header -->
                <div class="card-body">
                    <form id="form" action="{{ route('pemasukan_lainnya.update', ['instansi' => $instansi, 'pemasukan_lainnya' => $data->id]) }}" method="post">
                        @csrf
                        @method('patch')
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-4">
                              <div class="form-group">
                              <label>Total</label>
                              <input type="text" id="total" name="total" class="form-control" placeholder="Total Bayar" required value="{{ $data->total ?? 0 }}">
                              </div>
                          </div>
                          <div class="col-sm-4">
                              <div class="form-group">
