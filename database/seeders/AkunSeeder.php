...
class AkunSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $dataYayasan = [
            ...
            ['kode' => '1-608', 'nama' => 'Akum. Peny. Aset tetap Lainnya', 'tipe' => 'Akum. Penyusutan', 'jenis' => 'ASET TIDAK LANCAR', 'kelompok' => '-', 'saldo_awal' => 0, 'created_at' => $currentTimestamp, 'updated_at' => $currentTimestamp],
            ...
            ['kode' => '3-102', 'nama' => 'Aset Neto Dengan Pembatasan*', 'tipe' => 'Aset Neto', 'jenis' => 'ASET NETO', 'kelompok' => '-', 'saldo_awal' => 0, 'created_at' => $currentTimestamp, 'updated_at' => $currentTimestamp],
            ...
            ['kode' => '4-102', 'nama' => 'Pendapatan JPI Dengan Pembatasan*', 'tipe' => 'Pendapatan', 'jenis' => 'PENDAPATAN', 'kelompok' => '-', 'saldo_awal' => 0, 'created_at' => $currentTimestamp, 'updated_at' => $currentTimestamp],
            ...
            ['kode' => '4-104', 'nama' => 'Pendapatan Donasi*', 'tipe' => 'Pendapatan', 'jenis' => 'PENDAPATAN', 'kelompok' => '-', 'saldo_awal' => 0, 'created_at' => $currentTimestamp, 'updated_at' => $currentTimestamp],
            ...
            ['kode' => '5-117', 'nama' => 'Biaya Pembangunan', 'tipe' => 'Beban', 'jenis' => 'BEBAN', 'kelompok' => '-', 'saldo_awal' => 0, 'created_at' => $currentTimestamp, 'updated_at' => $currentTimestamp],
            ['kode' => '5-118', 'nama' => 'Biaya Pembelian Tanah', 'tipe' => 'Beban', 'jenis' => 'BEBAN', 'kelompok' => '-', 'saldo_awal' => 0, 'created_at' => $currentTimestamp, 'updated_at' => $currentTimestamp],
